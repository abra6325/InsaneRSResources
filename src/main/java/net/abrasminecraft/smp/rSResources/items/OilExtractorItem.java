...
public class OilExtractorItem {
    public static ItemStack get(){
        org.bukkit.inventory.ItemStack stack = new org.bukkit.inventory.ItemStack(Material.DROPPER);
        ItemMeta meta = stack.getItemMeta();
        meta.setDisplayName("Oil Extractor");
        ...
        tag.putInt(Key.getKey("id").toString(), Config.ItemID.OIL_RIG);
        nmsStack.setTag(tag);
