...
public class CreativeEnergySourceItem {
    public static ItemStack get(){
        org.bukkit.inventory.ItemStack stack = new org.bukkit.inventory.ItemStack(Material.ENCHANTING_TABLE);
        ItemMeta meta = stack.getItemMeta();
        meta.setDisplayName("Creative Energy Source");
        ...
        tag.putInt(Key.getKey("id").toString(), Config.ItemID.CREATIVE_SOURCE);
        nmsStack.setTag(tag);
